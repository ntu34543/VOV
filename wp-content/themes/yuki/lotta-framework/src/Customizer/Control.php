...
abstract class Control {
	...
	public function setLabel( $label ) {
		return $this->setParam( 'label', $label );
	}
	...
	public function setDescription( $desc ) {
		return $this->setParam( 'description', $desc );
	}
	...
	public function setSection( $id ) {
		return $this->setParam( 'section', $id );
	}
	 ...
	 * @return $this
	 */
	public function selectiveRefresh( string $selector, $callback, $args = [] ) {
		$this->postMessage();
