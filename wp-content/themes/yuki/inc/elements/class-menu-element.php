...
if ( !class_exists( 'Yuki_Menu_Element' ) ) {
    class Yuki_Menu_Element extends Element
    {
        ...
        {
            return [
                ( new Slider( $this->getSlug( 'top_level_height' ) ) )->setLabel( __( 'Items Height', 'yuki' ) )->bindSelectiveRefresh( 'yuki-dynamic-css' )->setDefaultValue( $this->getDefaultSetting( 'top-level-height', '50%' ) )->setDefaultUnit( '%' )->setMin( 5 )->setMax( 100 ),
                new Separator(),
                ( new Spacing( $this->getSlug( 'top_level_margin' ) ) )->setLabel( __( 'Items Margin', 'yuki' ) )->setDisabled( [ 'top', 'bottom' ] )->bindSelectiveRefresh( 'yuki-dynamic-css' )->setDefaultValue( $this->getDefaultSetting( 'top-level-margin', [
                'top'    => '0px',
                'bottom' => '0px',
                'left'   => '0px',
                'right'  => '0px',
                ...
                ( new Spacing( $this->getSlug( 'top_level_padding' ) ) )->setLabel( __( 'Items Padding', 'yuki' ) )->bindSelectiveRefresh( 'yuki-dynamic-css' )->setDefaultValue( $this->getDefaultSetting( 'top-level-padding', [
                'top'    => '4px',
                'bottom' => '4px',
                'left'   => '8px',
                'right'  => '8px',
                ...
                new Separator(),
                ( new Spacing( $this->getSlug( 'top_level_radius' ) ) )->setLabel( __( 'Items Border Radius', 'yuki' ) )->bindSelectiveRefresh( 'yuki-dynamic-css' )->setDefaultValue( $this->getDefaultSetting( 'top-level-radius', [
                'top'    => '0',
                'bottom' => '0',
                'left'   => '0',
                'right'  => '0',
        ...
        {
            $controls = [ ( new Typography( $this->getSlug( 'top_level_typography' ) ) )->setLabel( __( 'Typography', 'yuki' ) )->bindSelectiveRefresh( 'yuki-dynamic-css' )->setDefaultValue( $this->getDefaultSetting( 'top-level-typography', [
                'family'        => 'inherit',
                'fontSize'      => '0.7rem',
                'variant'       => '500',
                'lineHeight'    => '1',
        ...
        {
            return [
                ( new Slider( $this->getSlug( 'dropdown_width' ) ) )->setLabel( __( 'Min Width', 'yuki' ) )->bindSelectiveRefresh( 'yuki-dynamic-css' )->setDefaultValue( $this->getDefaultSetting( 'dropdown-width', '200px' ) )->setMin( 100 )->setMax( 300 ),
                ( new Radio( $this->getSlug( 'dropdown_direction' ) ) )->setLabel( __( 'Direction', 'yuki' ) )->selectiveRefresh( ...$this->selectiveRefresh() )->setDefaultValue( $this->getDefaultSetting( 'dropdown-direction', 'right' ) )->setChoices( [
                'left'  => __( 'Left', 'yuki' ),
                'right' => __( 'Right', 'yuki' ),
            ] ),
                new Separator(),
                ( new Spacing( $this->getSlug( 'dropdown_item_padding' ) ) )->setLabel( __( 'Items Padding', 'yuki' ) )->bindSelectiveRefresh( 'yuki-dynamic-css' )->setDefaultValue( $this->getDefaultSetting( 'dropdown-item-padding', [
                'top'    => '12px',
                'bottom' => '12px',
                'left'   => '12px',
                'right'  => '12px',
                ...
                ( new Spacing( $this->getSlug( 'dropdown_radius' ) ) )->setLabel( __( 'Dropdown Border Radius', 'yuki' ) )->bindSelectiveRefresh( 'yuki-dynamic-css' )->setDefaultValue( $this->getDefaultSetting( 'dropdown-radius', [
                'top'    => '3px',
                'bottom' => '3px',
                'left'   => '3px',
                'right'  => '3px',
        ...
        {
            $controls = [ ( new Typography( $this->getSlug( 'dropdown_typography' ) ) )->setLabel( __( 'Typography', 'yuki' ) )->bindSelectiveRefresh( 'yuki-dynamic-css' )->setDefaultValue( $this->getDefaultSetting( 'dropdown-typography', [
                'family'     => 'inherit',
                'fontSize'   => '0.75rem',
                'variant'    => '500',
                'lineHeight' => '1',
