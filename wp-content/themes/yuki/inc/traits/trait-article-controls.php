		...
		protected function getHeaderControls( $type, $defaults = [] ) {
			...
			return [
				( new Layers( 'yuki_' . $type . '_header_elements' ) )
					...
					->addLayer( 'title', __( 'Title', 'yuki' ), $this->getTitleLayerControls( $type, false, [
						'tag'        => 'h1',
						'typography' => [
							'family'     => 'inherit',
					...
					->addLayer( 'metas', __( 'Metas', 'yuki' ), $this->getMetasControls( $type, $defaults['metas'] ) )
					->addLayer( 'categories', __( 'Categories', 'yuki' ), $this->getTaxonomyControls( $type, '_cats', [
						'style'      => 'badge',
						'typography' => [
							'family'        => 'inherit',
							'fontSize'      => '0.75rem',
					...
					->addLayer( 'tags', __( 'Tags', 'yuki' ), $this->getTaxonomyControls( $type, '_tags' ) )
				,
