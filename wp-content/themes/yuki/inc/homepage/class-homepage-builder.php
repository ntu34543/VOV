...
if ( ! class_exists( 'Yuki_Homepage_Builder' ) ) {
	...
	class Yuki_Homepage_Builder {
		...
		protected function __construct() {
			$this->_builder = ( new PageBuilder( 'yuki_homepage_builder', Yuki_Homepage_Row::instance(), Yuki_Homepage_Column::instance() ) )
				...
				->addElement( ( new Yuki_Heading_Element( 'heading', __( 'Heading', 'yuki' ) ) ) )
				->addElement( ( new Yuki_Hero_Element( 'hero', __( 'Hero', 'yuki' ) ) ) )
				->addElement( ( new Yuki_Features_Element( 'features', __( 'Features', 'yuki' ) ) ) )
				->addElement( ( new Yuki_Reviews_Element( 'reviews', __( 'Reviews', 'yuki' ) ) ) )
				->addElement(
