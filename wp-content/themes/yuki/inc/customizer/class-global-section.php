    ...
    class Yuki_Global_Section extends CustomizerSection
    {
        ...
        protected function getLayoutControls()
        {
            return [ ( new Collapse() )->setLabel( __( 'Content Area Spacing', 'yuki' ) )->openByDefault()->setControls( [
                ( new Slider( 'yuki_homepage_content_spacing' ) )->setLabel( __( 'Homepage', 'yuki' ) )->enableResponsive()->bindSelectiveRefresh( 'yuki-dynamic-css' )->setDefaultUnit( 'px' )->setDefaultValue( '0px' ),
                ( new Slider( 'yuki_archive_content_spacing' ) )->setLabel( __( 'Archive', 'yuki' ) )->enableResponsive()->bindSelectiveRefresh( 'yuki-dynamic-css' )->setDefaultUnit( 'px' )->setDefaultValue( '24px' ),
                ( new Slider( 'yuki_single_post_content_spacing' ) )->setLabel( __( 'Single Post', 'yuki' ) )->enableResponsive()->bindSelectiveRefresh( 'yuki-dynamic-css' )->setDefaultUnit( 'px' )->setDefaultValue( '24px' ),
                ( new Slider( 'yuki_pages_content_spacing' ) )->setLabel( __( 'Pages', 'yuki' ) )->enableResponsive()->bindSelectiveRefresh( 'yuki-dynamic-css' )->setDefaultUnit( 'px' )->setDefaultValue( '24px' )
            ] ) ];
        }
        ...
        protected function getScrollToTopControls()
        {
            return [ ( new Tabs() )->setActiveTab( 'content' )->addTab( 'content', __( 'Content', 'yuki' ), [
                ...
                new Separator(),
                ( new Slider( 'yuki_to_top_icon_size' ) )->setLabel( __( 'Icon Size', 'yuki' ) )->bindSelectiveRefresh( 'yuki-dynamic-css' )->enableResponsive()->setMin( 10 )->setMax( 50 )->setDefaultUnit( 'px' )->setDefaultValue( '14px' ),
                new Separator(),
                ( new Slider( 'yuki_to_top_bottom_offset' ) )->setLabel( __( 'Bottom Offset', 'yuki' ) )->bindSelectiveRefresh( 'yuki-dynamic-css' )->enableResponsive()->setMin( 5 )->setMax( 300 )->setDefaultUnit( 'px' )->setDefaultValue( '48px' ),
                ( new Slider( 'yuki_to_top_side_offset' ) )->setLabel( __( 'Side Offset', 'yuki' ) )->bindSelectiveRefresh( 'yuki-dynamic-css' )->enableResponsive()->setMin( 5 )->setMax( 300 )->setDefaultUnit( 'px' )->setDefaultValue( '48px' ),
                new Separator(),
