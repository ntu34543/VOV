...
function yuki_content_buttons_css()
{
    return array_merge(
        ...
        Css::shadow( CZ::get( 'yuki_content_buttons_shadow' ) ),
 ...
 * @return array
 */
function yuki_content_buttons_hover_css()
{
    return Css::shadow( CZ::get( 'yuki_content_buttons_shadow_active' ) );
}
...
function yuki_dynamic_css()
{
    ...
    if ( is_single() || is_page() ) {
        ...
        $css['.yuki-article-content .wp-block-button:hover, .yuki-comments-area [type="submit"]:hover'] = yuki_content_buttons_hover_css();
        // Post navigation
        if ( is_single() ) {
    ...
    if ( YUKI_WOOCOMMERCE_ACTIVE ) {
        ...
        $css[implode( ':hover,', $woo_buttons )] = yuki_content_buttons_hover_css();
        // form
